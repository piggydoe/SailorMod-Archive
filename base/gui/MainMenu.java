...
import base.Client;
import base.gui.clickgui.screen.GuiLogin;
...
public class MainMenu extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		mc.getTextureManager().bindTexture(new ResourceLocation("client/sailormodmcbg.png"));
		this.drawModalRectWithCustomSizedTexture(0, 0, 0, 0, this.width, this.height, this.width, this.height);
		
		//Gui.drawRect(this.width - 100, 450, 100, this.height - 10, new Color(0,0,0,170).getRGB());
		RoundedUtils.drawRoundedRect(245, 420, 300 + 420, 300 + 215, 15, new Color(0,0,0,200).getRGB());
	...
	public void initGui() {
		...
		Client.INSTANCE.getRP().update("Idle", "SailorMod Menu");
		...
		this.buttonList.add(new GuiButton(6969, 5, 5, 100, 20, "Change Session"));
	...
	if(button.id == 0) {
		mc.displayGuiScreen(new ClientPage());
	}
	if(button.id == 6969) {
