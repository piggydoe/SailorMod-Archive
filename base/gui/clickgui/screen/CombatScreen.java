...
import base.gui.clickgui.ModButton;
import base.gui.clickgui.ModCard;
...
public class CombatScreen extends GuiScreen{
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FontUtil.normal.drawCenteredString("Combat", 260, 30.0f, -1);
	...
	public void initGui() {
		...
		this.modButtons.add(new ModButton(320, 225, 65, mc.fontRendererObj.FONT_HEIGHT + 5, Client.INSTANCE.hudManager.targetHud));
		this.modButtons.add(new ModButton(475, 125, 65, mc.fontRendererObj.FONT_HEIGHT + 5, Client.INSTANCE.hudManager.potCounter));
		this.modButtons.add(new ModButton(630, 125, 65, mc.fontRendererObj.FONT_HEIGHT + 5, Client.INSTANCE.hudManager.keystrokes));
		this.modButtons.add(new ModButton(320, 125, 65, mc.fontRendererObj.FONT_HEIGHT + 5, Client.INSTANCE.hudManager.potStatus));
