...
public class WorldScreen extends GuiScreen{ //this is a really dumb way of what i am doing, dont ever do this
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FontUtil.normal.drawCenteredString("World", 260, 30.0f, -1);
	...
	public void initGui() {
		...
		super.initGui();
		this.modButtons.add(new ModButton(320, 125, 65, mc.fontRendererObj.FONT_HEIGHT + 5, Client.INSTANCE.hudManager.xyz));
		this.modButtons.add(new ModButton(475, 125, 65, mc.fontRendererObj.FONT_HEIGHT + 5, Client.INSTANCE.hudManager.ping));
