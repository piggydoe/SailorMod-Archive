...
public class PotStatus extends HudMod{
	...
	public void draw() {
        ...
        if (!collection.isEmpty()) {
            ...
            for (PotionEffect potioneffect : this.mc.thePlayer.getActivePotionEffects()) {
                ...
                fr.drawStringWithShadow(s, (float) getX() + 43, (float) (getY() + j + 5), 16777215);
                String s1 = Potion.getDurationString(potioneffect);
                fr.drawStringWithShadow(EnumChatFormatting.GRAY + s1, (float) getX() + 20, (float) (getY() + j + 5), 8355711);
                j += k;
        }
    }
	    }
	...
	public void renderDummy(int mouseX, int mouseY) {
        ...
        fr.drawStringWithShadow(EnumChatFormatting.GRAY + "0:00" + EnumChatFormatting.DARK_GRAY +" I", (float) getX() + 20, (float) (getY() + j + 5), -1);
        fr.drawStringWithShadow(EnumChatFormatting.GRAY + "0:00" + EnumChatFormatting.DARK_GRAY +" II", (float) getX() + 20, (float) (getY() + j + 22), -1);
        fr.drawStringWithShadow(EnumChatFormatting.GRAY + "0:00" + EnumChatFormatting.DARK_GRAY +" III", (float) getX() + 20, (float) (getY() + j + 38), -1);
        fr.drawStringWithShadow(EnumChatFormatting.GRAY + "0:00" + EnumChatFormatting.DARK_GRAY +" IV", (float) getX() + 20, (float) (getY() + j + 55), -1);
